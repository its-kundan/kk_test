...
class Camera:
    ...
    def __init__(self):
        ...
        rospy.Subscriber('/swift/camera_rgb/image_raw', CompressedImage, self.callback)
        self.arm()
    ...
    def callback(self, data):
        ...
        # Iterate through each contour and calculate the centroid
        ...
        # Call the detect_and_land function with the centroid coordinates
        self.detect_and_land(centroid_coordinates)
    ...
    def get_organism_type(self, num_leds):
        # Map the number of LEDs to organism type
        organism_type = {2: 'alien_a', 3: 'alien_b', 4: 'alien_c'}
        return organism_type.get(num_leds, 'unknown')
